...
public class MimeBodyPart extends BodyPart implements MimePart {
	...
	PropUtil.getBooleanSystemProperty(
	    "javamail.mime.setdefaulttextcharset", true);

    private static final boolean setContentTypeFileName =
	PropUtil.getBooleanSystemProperty(
	    "javamail.mime.setcontenttypefilename", true);

    private static final boolean encodeFileName =
	PropUtil.getBooleanSystemProperty("javamail.mime.encodefilename", false);
    private static final boolean decodeFileName =
	PropUtil.getBooleanSystemProperty("javamail.mime.decodefilename", false);
    private static final boolean ignoreMultipartEncoding =
	PropUtil.getBooleanSystemProperty(
	    "javamail.mime.ignoremultipartencoding", true);

    // Paranoia:
    // allow this last minute change to be disabled if it causes problems
    static final boolean cacheMultipart = 	// accessed by MimeMessage
	PropUtil.getBooleanSystemProperty("javamail.mime.cachemultipart", true);
     ...
     *
     * If the <code>javamail.mime.decodefilename</code> System property
   ...
   /**
     ...
     *
     * <br>
     * - A message being crafted by a javamail application will certainly
	...
	try {
	    ...
	    if (cType.match("message/*") &&
		    !PropUtil.getBooleanSystemProperty(
			"javamail.mime.allowencodedmessages", false))
		return null;
