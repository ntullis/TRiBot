...
import metapi.javamail.mail.util.ReadableMime;
...
public class POP3Message extends MimeMessage implements ReadableMime {
	...
	synchronized(this) {
		...
		if (headers == null ||
		     ...
		     *
		     * XXX - It seems that some javamail servers return slightly
	 ...
	 * cache or if the "javamail.pop3.keepmessagecontent" prop is set.
	 */
	TempFile cache = folder.getFileCache();
	if (cache != null ||
     ...
     * specified headers.  If the property "javamail.pop3.cachewriteto"
