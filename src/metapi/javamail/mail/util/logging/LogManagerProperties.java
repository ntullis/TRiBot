...
import metapi.javamail.mail.Authenticator;
...
final class LogManagerProperties extends Properties {
     ...
     */
    private String preWrite(final Object key) {
     ...
     */
    private synchronized Properties writeReplace() throws ObjectStreamException {
        assert false;
