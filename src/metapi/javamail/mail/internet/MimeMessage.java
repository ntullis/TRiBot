...
import metapi.javamail.mail.util.SharedByteArrayInputStream;
 ...
 * @see	metapi.javamail.mail.internet.MimeUtility
 * @see	metapi.javamail.mail.Part
 * @see	metapi.javamail.mail.Message
 * @see	metapi.javamail.mail.internet.MimePart
 * @see	metapi.javamail.mail.internet.InternetAddress
 */
...
public class MimeMessage extends Message implements MimePart {
    ...
    /**
     * This inner class extends the javax.javamail.Message.RecipientType
     * class to add additional RecipientTypes. The one additional
     * RecipientType currently defined here is NEWSGROUPS.
     *
     * @see metapi.javamail.mail.Message.RecipientType
     */
     ...
     * @see		#headers
     * @see		metapi.javamail.mail.Message.RecipientType#TO
     * @see		metapi.javamail.mail.Message.RecipientType#CC
     * @see		metapi.javamail.mail.Message.RecipientType#BCC
     * @see		metapi.javamail.mail.internet.MimeMessage.RecipientType#NEWSGROUPS
     */
     ...
     * @see        metapi.javamail.mail.search.MessageIDTerm
     * @since 	   JavaMail 1.1
     */
     ...
     * {@link metapi.javamail.mail.Flags.Flag#ANSWERED ANSWERED} flag is set
     * in this message. <p>
     *
     * The "Subject" field is filled in with the original subject
     * prefixed with "Re:" (unless it already starts with "Re:").
     ...
     *
     * @exception metapi.javamail.mail.MessagingException
     * @exception IOException	if an error occurs writing to the stream
     *				or if an error is generated by the
     *				javax.activation layer.
     * @see javax.activation.DataHandler#writeTo
     ...
     * @exception  	MessagingException
     * @see 		metapi.javamail.mail.Flags
     */
     ...
     * @see 		metapi.javamail.mail.Flags.Flag
     * @see		metapi.javamail.mail.Flags.Flag#ANSWERED
     * @see		metapi.javamail.mail.Flags.Flag#DELETED
     * @see		metapi.javamail.mail.Flags.Flag#DRAFT
     * @see		metapi.javamail.mail.Flags.Flag#FLAGGED
     * @see		metapi.javamail.mail.Flags.Flag#RECENT
     * @see		metapi.javamail.mail.Flags.Flag#SEEN
     * @exception       MessagingException
     */
