...
public enum Banks {
    ...
    CATHERBY("Catherby", 6, new RSTile(2809, 3439, 0), 0, 956, 1740),
    AL_KHARID("Al Kharid", 4, new RSTile(3270, 3165, 0), 7126, 1742, 1741),
    DRAYNOR("Draynor", 7, new RSTile(3093, 3242, 0), 7126, 1740, 956),
    EDGEVILLE("Edgeville", 4, new RSTile(3093, 3489, 0), 7126, 956, 1740),
    FISHING_GUILD("Fishing Guild", 8, new RSTile(2587, 3420, 0), 23961, 956, 1740),
    SEER_VILLAGE("Seer's Village", 8, new RSTile(2739, 3496, 0), 25809, 1740, 956);
