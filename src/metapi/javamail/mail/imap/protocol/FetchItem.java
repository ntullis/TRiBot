...
import metapi.javamail.mail.FetchProfile;
import metapi.javamail.mail.iap.ParsingException;
...
public abstract class FetchItem { 
     ...
     */
    public abstract Serializable parseItem(FetchResponse r) throws ParsingException;
}
