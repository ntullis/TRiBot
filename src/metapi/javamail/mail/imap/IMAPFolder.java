...
package metapi.javamail.mail.imap;
...
import metapi.javamail.mail.search.*;

import metapi.javamail.mail.util.*;
import metapi.javamail.mail.iap.*;
import metapi.javamail.mail.imap.protocol.*;
 ...
 * for more information. <p>
 *
 * The {@link #open(int, metapi.javamail.mail.imap.ResyncData) open(int,ResyncData)}
 * method and {@link metapi.javamail.mail.imap.ResyncData ResyncData} class supports
...
public class IMAPFolder extends Folder implements UIDFolder, ResponseHandler {
	...
	*/
	 ...
	 * the LIST pattern is '%' or '*'. i.e, <LIST "" javamail/%>
	 * returns "javamail/" as the first LIST response.
	 *
	...
	Utility.Condition condition =
	    ...
	    Response[] r = null;
	    Vector<Response> v = new Vector<Response>(); // to collect non-FETCH responses &
	...
	try {
		...
		if (uidTable != null) {
		    Vector<Long> v = new Vector<Long>(); // to collect unavailable UIDs
		    Long l;
		    for (int i = 0; i < uids.length; i++) {
     ...
     * of the <code>com.sun.javamail.iap</code> and
     * <code>com.sun.javamail.imap.protocol</code> packages, best acquired by
     * reading the source code. <p>
     *
     * <blockquote><pre>
     * import com.sun.javamail.iap.*;
     * import com.sun.javamail.imap.*;
     * import com.sun.javamail.imap.protocol.*;
     *
     * ...
     *
