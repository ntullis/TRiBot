...
import metapi.mail.internet.InternetHeaders;
import metapi.mail.internet.MimeMessage;
import metapi.mail.internet.SharedInputStream;
...
public class MboxFolder extends Folder {
    ...
    private static final boolean homeRelative =
            Boolean.getBoolean("javamail.mbox.homerelative");
...
//System.out.println(name + " atime " + atime + " mtime " + mtime);
	...
	/*
	 * Have to save any new javamail that's been appended to the
        ...
        try {
            ...
            if (wr == 0 && closing) {
                String skeep = ((MboxStore) store).getSession().
                        getProperty("javamail.mbox.deleteEmpty");
