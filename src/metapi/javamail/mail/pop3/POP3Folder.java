 ...
 *
 * @author      Bill Shannon
 * @author	John Mani (ported to the javax.javamail APIs)
 */
public class POP3Folder extends Folder {
	...
	try {
	     ...
	     * the javamail.pop3.rsetbeforequit property to true.  This
    ...
    protected POP3Message createMessage(Folder f, int msgno)
				throws MessagingException {
	POP3Message m = null;
	Constructor<POP3Message> cons = store.messageConstructor;
	if (cons != null) {
	    try {
