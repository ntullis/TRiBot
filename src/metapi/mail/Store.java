...
import metapi.mail.event.FolderEvent;
import metapi.mail.event.FolderListener;
import metapi.mail.event.StoreEvent;
import metapi.mail.event.StoreListener;
 ...
 * @author John Mani
 * @author Bill Shannon
 * @see metapi.mail.Service
 * @see metapi.mail.event.ConnectionEvent
 * @see metapi.mail.event.StoreEvent
 */
...
public abstract class Store extends Service {
     ...
     * Typically, only the authenticated user has access to javamail folders
     ...
     * personal namespaces for the user.  To access javamail folders in the
     ...
     * A shared namespace is a namespace that consists of javamail folders
    ...
    private volatile Vector<EventListener> storeListeners = null;
    ...
    public synchronized void addStoreListener(StoreListener l) {
        if (storeListeners == null)
            storeListeners = new Vector<EventListener>();
