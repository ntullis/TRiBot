...
public class UUDecoderStream extends FilterInputStream {
     ...
     * The System property <code>javamail.mime.uudecode.ignoreerrors</code>
     * controls whether errors in the encoded data cause an exception
     * or are ignored.  The default is false (errors cause exception).
     * The System property <code>javamail.mime.uudecode.ignoremissingbeginend</code>
	...
	ignoreErrors = PropUtil.getBooleanSystemProperty(
	    "javamail.mime.uudecode.ignoreerrors", false);
	// default to false
	ignoreMissingBeginEnd = PropUtil.getBooleanSystemProperty(
	    "javamail.mime.uudecode.ignoremissingbeginend", false);
    }
