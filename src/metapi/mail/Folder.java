...
public abstract class Folder {
     ...
     * @see 		#HOLDS_FOLDERS
     * @see		#HOLDS_MESSAGES
     * @see		metapi.mail.event.FolderEvent
     */
     ...
     * @see		metapi.mail.event.MessageChangedEvent
     */
     ...
     * @see		metapi.mail.event.MessageCountEvent
     */
     ...
     * @exception       metapi.mail.search.SearchException if the search
     *			term is too complex for the implementation to handle.
     * @exception	FolderNotFoundException if this folder does 
     *			not exist.
     * @exception	IllegalStateException if this folder is not opened.
     * @exception       MessagingException
     * @see		metapi.mail.search.SearchTerm
     */
