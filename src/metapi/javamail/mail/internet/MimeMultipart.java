...
import java.io.*;
import metapi.javamail.mail.util.LineOutputStream;
import metapi.javamail.mail.util.LineInputStream;
import metapi.javamail.mail.util.ASCIIUtility;
import metapi.javamail.mail.util.PropUtil;
 ...
 * content. The intent is that service providers, javamail JavaBean writers
 * and javamail clients will write many such subclasses and their Command
 ...
 *
 * The <code>javamail.mime.multipart.ignoremissingendboundary</code>
 ...
 *
 * The <code>javamail.mime.multipart.ignoremissingboundaryparameter</code>
 ...
 *
 * The <code>javamail.mime.multipart.ignoreexistingboundaryparameter</code>
 ...
 * as with <code>javamail.mime.multipart.ignoremissingboundaryparameter</code>. <p>
 *
 ...
 * <code>javamail.mime.multipart.allowempty</code> System property may be set to
...
public class MimeMultipart extends Multipart {
    ...
    /**
     * Flag corresponding to the "javamail.mime.multipart.ignoremissingendboundary"
     ...
     * "javamail.mime.multipart.ignoremissingboundaryparameter"
     * property, set in the {@link #initializeProperties} method called from
     * constructors and the parse method.
     *
     * @since	JavaMail 1.5
    ...
    /**
     * Flag corresponding to the
     * "javamail.mime.multipart.ignoreexistingboundaryparameter"
     * property, set in the {@link #initializeProperties} method called from
     * constructors and the parse method.
     *
     * @since	JavaMail 1.5
    ...
    /**
     * Flag corresponding to the "javamail.mime.multipart.allowempty"
     * property, set in the {@link #initializeProperties} method called from
     * constructors and the parse method.
     *
     * @since	JavaMail 1.5
	...
	ignoreMissingEndBoundary = PropUtil.getBooleanSystemProperty(
	    "javamail.mime.multipart.ignoremissingendboundary", true);
	// default to true
	ignoreMissingBoundaryParameter = PropUtil.getBooleanSystemProperty(
	    "javamail.mime.multipart.ignoremissingboundaryparameter", true);
	// default to false
	ignoreExistingBoundaryParameter = PropUtil.getBooleanSystemProperty(
	    "javamail.mime.multipart.ignoreexistingboundaryparameter", false);
	// default to false
	allowEmpty = PropUtil.getBooleanSystemProperty(
	    "javamail.mime.multipart.allowempty", false);
    }
     ...
     * "javamail.mime.multipart.ignoremissingendboundary" is set to
