 ...
 * @see metapi.javamail.mail.Session#getInstance(java.util.Properties,
 *					metapi.javamail.mail.Authenticator)
 * @see metapi.javamail.mail.Session#getDefaultInstance(java.util.Properties,
 *					metapi.javamail.mail.Authenticator)
 * @see metapi.javamail.mail.Session#requestPasswordAuthentication
 * @see metapi.javamail.mail.PasswordAuthentication
 *
 * @author  Bill Foote
 * @author  Bill Shannon
 */
...
public abstract class Authenticator {
     ...
     * @return the protcol
     *
     * @see metapi.javamail.mail.URLName#getProtocol
     */
