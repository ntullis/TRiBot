...
public abstract class Transport extends Service {
     ...
     * @see		metapi.javamail.mail.SendFailedException
     */
	 ...
	 */
	Hashtable<String, Vector<Address>> protocols = new Hashtable<String, Vector<Address>>();
    ...
    private volatile Vector<EventListener> transportListeners = null;
	...
	if (transportListeners == null)
	    transportListeners = new Vector<EventListener>();
