...
public abstract class Message implements Part {
     ...
     * attribute is obtained from the property "javamail.user". If this
     ...
     * </pre></blockquote><p>
     *
     * @see metapi.javamail.mail.Message#getRecipients
     * @see metapi.javamail.mail.Message#setRecipients
     * @see metapi.javamail.mail.Message#addRecipients
     */
	 ...
	 */
	protected RecipientType readResolve() throws ObjectStreamException {
	    if (type.equals("To"))
		return TO;
