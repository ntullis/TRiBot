 ...
 * The <code>javamail.mime.encodeparameters</code> and
 * <code>javamail.mime.decodeparameters</code> System properties
 ...
 * <code>javamail.mime.decodeparameters.strict</code> to <code>"true"</code>
 ...
 * <code>javamail.mime.parameters.strict</code>, which if set to false
...
public class ParameterList {
	...
	PropUtil.getBooleanSystemProperty("javamail.mime.decodeparameters", true);
    private static final boolean decodeParametersStrict =
	PropUtil.getBooleanSystemProperty(
	    "javamail.mime.decodeparameters.strict", false);
    private static final boolean applehack =
	PropUtil.getBooleanSystemProperty("javamail.mime.applefilenames", false);
    private static final boolean windowshack =
	PropUtil.getBooleanSystemProperty("javamail.mime.windowsfilenames", false);
    private static final boolean parametersStrict = 
	PropUtil.getBooleanSystemProperty("javamail.mime.parameters.strict", true);
     ...
     * <code>javamail.mime.encodeparameters</code> System property
